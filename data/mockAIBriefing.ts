...
export const MOCK_AI_BRIEFING: AIBriefing = {
  ...
  situationalSummary:
    'The New York City metropolitan area is experiencing a compound disaster event of unprecedented operational complexity. Three simultaneous critical incidents — a five-alarm fire in Midtown, a mass casualty event at Grand Central Terminal, and a chemical hazmat spill in Red Hook — are straining emergency response capacity to critical thresholds. AI risk modeling indicates a 73% probability of resource saturation within the next 90 minutes if current deployment patterns are maintained.',
  keyRisks: [
    'Resource depletion: Fire and EMS units at 87% deployment capacity — reserve critically low',
    'Compound cascade: Grand Central collapse may trigger secondary structural failures in adjacent buildings',
    ...
    'Access compromise: Queensboro Bridge closure blocking emergency access routes in 4 districts',
  ],
  recommendations: [
    {
      id: 'REC-001',
    ...
    },
    {
      id: 'REC-003',
      priority: 'urgent',
      action: 'Pre-position water rescue assets along FDR Drive for flood expansion',
      rationale:

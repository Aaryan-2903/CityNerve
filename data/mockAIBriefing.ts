import type { AIBriefing } from '@/types/ai';
...
export const MOCK_AI_BRIEFING: AIBriefing = {
  ...
  situationalSummary:
    'The Mumbai metropolitan area is experiencing a compound disaster event of unprecedented operational complexity. Three simultaneous critical incidents — a five-alarm fire in BKC, a mass casualty event at CSMT, and a chemical hazmat spill in Dharavi — are straining emergency response capacity to critical thresholds. AI risk modeling indicates a 73% probability of resource saturation within the next 90 minutes if current deployment patterns are maintained.',
  keyRisks: [
    'Resource depletion: Fire and EMS units at 87% deployment capacity — reserve critically low',
    'Compound cascade: Dadar Station collapse may trigger secondary structural failures in adjacent buildings',
    'Storm amplification: Tornado warning for Navi Mumbai will redirect 30% of available air assets',
    'Hospital surge: NYU Langone and Bellevue approaching trauma capacity with 34 confirmed casualties',
    'Access compromise: Bandra-Worli Sea Link closure blocking emergency access routes in 4 districts',
  ],
  recommendations: [
    {
      id: 'REC-001',
    ...
    },
    {
      id: 'REC-003',
      priority: 'urgent',
      action: 'Pre-position water rescue assets along Western Express Highway for flood expansion',
      rationale:
  ...
  predictedEscalations: [
    'INC-001: Fire likely to spread to adjacent building at 1251 6th Ave within 45 minutes',
    'INC-002: Flooding will reach Zone C residential area in approximately 2.5 hours',
    'INC-007: Tornado touchdown probability increases to 92% after 22:30 local time',
  ],

...
export function WeatherWidget() {
  ...
  const currentWeather = sim && sim.status !== 'idle' ? sim.weather : liveWeather;
      ...
      <AnimatePresence mode="wait">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <div className="flex items-center gap-2 rounded-lg border border-white/[0.05] bg-white/[0.02] px-2.5 py-2">
            <div className="w-3.5 h-3.5 shrink-0 text-orange-400">🌡️</div>
            <div>
          ...
          {/* Humidity */}
          <div className="flex items-center gap-2 rounded-lg border border-white/[0.05] bg-white/[0.02] px-2.5 py-2">
            <div className="w-3.5 h-3.5 shrink-0 text-cyan-400">💧</div>
            <div>
          ...
          {/* Wind */}
          <div className="flex items-center gap-2 rounded-lg border border-white/[0.05] bg-white/[0.02] px-2.5 py-2">
            <div className="w-3.5 h-3.5 shrink-0 text-slate-400">💨</div>
            <div>
